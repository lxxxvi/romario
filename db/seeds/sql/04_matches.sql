...
--   left_team_score          INTEGER,
--   right_team_score         INTEGER,
--   kickoff_at               TIME          NOT NULL,
--   comments                 TEXT
-- );

-- ALTER TABLE matches ADD CONSTRAINT match_venue_id_fk FOREIGN KEY (venue_id) REFERENCES venues (id);
-- ALTER TABLE matches ADD CONSTRAINT match_left_team_id_fk  FOREIGN KEY (left_team_id)  REFERENCES teams (id);
-- ALTER TABLE matches ADD CONSTRAINT match_right_team_id_fk FOREIGN KEY (right_team_id) REFERENCES teams (id);
-- ALTER TABLE matches ADD CONSTRAINT uniqe_match_phase_ak UNIQUE (phase, left_team_id, right_team_id);
